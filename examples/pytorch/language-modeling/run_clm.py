...
def main():
    ...
    training_args.spmd_auto_sharding = model_args.spmd_auto_sharding

    import torch_xla.core.xla_model as xm
    import torch_xla.experimental.xla_sharding as xs
    import torch_xla.runtime as xr
    if training_args.spmd_auto_sharding:
      # TODO(yeounoh) trainer doesn't seem to pick up these
      print('Using SPMD Auto-Sharding...')
      os.environ['XLA_USE_SPMD'] = '1'
      os.environ['XLA_AUTO_SPMD'] = '1'
    else:
      print('SPMD Auto-Sharidng disabled...')
    ...
    with context:
        if model_args.model_name_or_path:
            torch_dtype = (model_args.torch_dtype if model_args.torch_dtype
                           in ["auto", None] else getattr(
